      ...
      <div className="px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-20">
          ...
          <div className="md:col-span-8">
            <h2 className="font-display text-[44px] md:text-[88px] leading-[0.92] font-black tracking-[-0.045em] text-white">
              The Method
              <br />
              <span className="font-serif italic font-light">— a 22-week protocol.</span>
            </h2>
          </div>
        </div>
        ...
        <ol className="space-y-2 border-t border-white/10">
          {steps.map((s) => (
            <li
              key={s.n}
              className="grid grid-cols-1 md:grid-cols-12 gap-6 border-b border-white/10 py-10 md:py-14 group"
              data-cursor="Phase"
            >
              ...
              <div className="md:col-span-7">
                <h3 className="font-display text-[36px] md:text-[64px] font-black leading-[0.95] tracking-[-0.045em] text-white transition-colors group-hover:text-white">
                  {s.t}
                </h3>
